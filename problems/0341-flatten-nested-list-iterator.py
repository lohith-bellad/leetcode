...
class NestedInteger:
    ...
    def getInteger(self) -> int:
        ...
        single integer. Return None if this NestedInteger holds a nested list.
        """
        pass
    ...
    def getList(self) -> list:
        ...
        nested list. Return None if this NestedInteger holds a single integer.
        """
        pass
    ...
    def __init__(self, nestedList: list[NestedInteger]):
        ...
        while self.temp:
            ...
            if elem.isInteger():
                ...
                for e in reversed(elem.getList()):
                    self.temp.append(e)
