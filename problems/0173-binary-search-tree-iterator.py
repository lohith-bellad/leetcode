...
a binary search tree (BST):
    ...
    * BSTIterator(TreeNode root) Initializes an object of the BSTIterator class. The root
      of the BST is given as part of the constructor. The pointer should be initialized to
...
Follow up:
    * Could you implement next() and hasNext() to run in average O(1) time and use O(h)
